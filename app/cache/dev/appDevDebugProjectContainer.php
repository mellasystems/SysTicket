...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'systicketdb', 'user' => 'root', 'password' => 'mescyt', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf_orm_default_0fe86d34086e9fa2cd46bce3623d8fa999405279b21a306d9649dfa2ad9a1932');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('9e719475973a2a34a8feaab6176b5deebd1448ef');
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('5a31a234d00e71.19341569')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'database_port' => NULL,
            'database_name' => 'systicketdb',
            'database_user' => 'root',
            'database_password' => 'mescyt',
            'mailer_transport' => 'smtp',
            'mailer_host' => '127.0.0.1',
            'mailer_user' => NULL,
            'mailer_password' => NULL,
            'secret' => '9e719475973a2a34a8feaab6176b5deebd1448ef',
            'locale' => 'en',
            ...
            'kernel.secret' => '9e719475973a2a34a8feaab6176b5deebd1448ef',
            ...
            'console.command.ids' => array(
                ...
                24 => 'fos_js_routing.dump_command',
                25 => 'fos_js_routing.router_debug_exposed_command',
                26 => 'sensio_distribution.security_checker.command',
            ),
        );
    }
}
